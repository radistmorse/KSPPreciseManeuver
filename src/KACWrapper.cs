  ...
  public class KACWrapper {
    ...
    public class KACAPI {
      ...
      private void AlarmStateChanged (object actualEvent) {
        OnAlarmStateChanged?.Invoke (new AlarmStateChangedEventArgs (actualEvent, this));
      }
      #endregion
      ...
      public class KACAlarm {
        ...
        public String VesselID {
          get {
            return (String)VesselIDField.GetValue (actualAlarm);
          }
          set {
            VesselIDField.SetValue (actualAlarm, value);
          }
        }
        ...
        public String ID {
          get {
            return (String)IDField.GetValue (actualAlarm);
          }
        }
        ...
        public String Name {
          get {
            return (String)NameField.GetValue (actualAlarm);
          }
          set {
            NameField.SetValue (actualAlarm, value);
          }
        }
        ...
        public String Notes {
          get {
            return (String)NotesField.GetValue (actualAlarm);
          }
          set {
            NotesField.SetValue (actualAlarm, value);
          }
        }
        ...
        public String XferOriginBodyName {
          get {
            return (String)XferOriginBodyNameField.GetValue (actualAlarm);
          }
          set {
            XferOriginBodyNameField.SetValue (actualAlarm, value);
          }
        }
        ...
        public String XferTargetBodyName {
          get {
            return (String)XferTargetBodyNameField.GetValue (actualAlarm);
          }
          set {
            XferTargetBodyNameField.SetValue (actualAlarm, value);
          }
        }
        ...
        public AlarmTypeEnum AlarmType {
          get {
            return (AlarmTypeEnum)AlarmTypeField.GetValue (actualAlarm);
          }
        }
        ...
        public Double AlarmTime {
          get {
            return (Double)AlarmTimeProperty.GetValue (actualAlarm, null);
          }
          set {
            AlarmTimeProperty.SetValue (actualAlarm, value, null);
          }
        }
        ...
        public Double AlarmMargin {
          get {
            return (Double)AlarmMarginField.GetValue (actualAlarm);
          }
          set {
            AlarmMarginField.SetValue (actualAlarm, value);
          }
        }
        ...
        public AlarmActionEnum AlarmAction {
          get {
            return (AlarmActionEnum)AlarmActionField.GetValue (actualAlarm);
          }
          set {
            AlarmActionField.SetValue (actualAlarm, (Int32)value);
          }
        }
        ...
        public Double Remaining {
          get {
            return (Double)RemainingField.GetValue (actualAlarm);
          }
        }
        ...
        public Boolean RepeatAlarm {
          get {
            return (Boolean)RepeatAlarmField.GetValue (actualAlarm);
          }
          set {
            RepeatAlarmField.SetValue (actualAlarm, value);
          }
        }
        ...
        public Double RepeatAlarmPeriod {
          ...
          set {
            RepeatAlarmPeriodProperty.SetValue (actualAlarm, value, null);
          }
        }
